...
export default async function Home() {
  ...
  return (
    <main className="main-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">
      <header className="bg-white/80 backdrope-blur-sm border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <Image
              src={"/Screenshot 2026-03-12 at 13.02.30.png"}
              alt="logo"
              width={900}
              height={200}
          ...
          {products.length === 0 && (
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
              {FEATURES.map(({ icon: Icon, title, description }) => (
                ...
                >
                  <div className="w-12 h-12 bg-violet-200 rounded-lg flex items-center justify-center mb-4 mx-auto">
      ...
      {user && products.length === 0 && (
        <section className="max-w-2xl mx-auto px-4 pb-20 text-center">
          <div className="bg-white rounded-xl border-2 border-gray-300 border-dashed p-12">
