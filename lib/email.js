...
export async function sendPriceDropEmail( userEmail , product , oldPrice , newPrice) {
    try{
        ...
        const {data , error} = await resent.emails.send({
            ...
            to : userEmail ,
            subject : `🥳Price drop alert: ${product.name} is now ${product.currency} cheaper !` ,
            html : `
        <!DOCTYPE html>
        <html>
          <head>
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; margin-top: 20px; text-align: center; color: #6b7280; font-size: 12px;">
                ...
                <p style="margin-top: 10px;">
                  <a href="" style="color: #FA5D19; text-decoration: none;">
